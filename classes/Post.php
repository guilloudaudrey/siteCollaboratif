...
class Post {
    ...
    public function asHtmlAnnonce() { 
        return '<div class="row" style="background: yellow"><h3>' . $this->getTitle() . '</h3></div>' 
                ...
                . '<div><img src="images/travaux.png" class="img-fluid" alt="Responsive image" style="width: 100%;height: auto"></div></figure>'
                . '<span class="badge" style="margin-right : 5px">' . $this->getTypeannonce() . '</span><span class="badge badge-primary" style="margin-right : 5px">' . $this->getCategorie() . '</span><span class="badge badge-info">' . $this->getLocalisation() . '</span>'
                . '<p>' . $this->getDescription() . '</p>'
                . '<p>' . $this->getPrice() . ' €</p>'
